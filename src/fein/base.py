...
class AdapterConfig:
    target_modules: str | list[str] | None = field(
        ...
        metadata={
            ...
            "replace with Lora. For example, ['q', 'v'] or "
    ...
    modules_to_save: list[str] = field(
        ...
        metadata={
            "help": "List of modules apart from LoRA layers to be set as trainable and "
            "saved in the final checkpoint. For example, in Sequence Classification or "
            "Token Classification tasks, the final layer `classifier/score` are "
